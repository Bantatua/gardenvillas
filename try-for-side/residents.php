...
<!-- Modal -->
  ...
  <div class="d-flex align-items-center">
    <button type="button" mx-auto class="btn btn-primary me-3" id="add" data-bs-toggle="modal" data-bs-target="#addModal">
      Add Resident
    </button>
    <input type="text" mx-auto class="form-control" id="searchInput" placeholder="Search">
  </div>
</div>
                ...
                <?php foreach ($users as $user) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="residents.php?delete=<?= $user['id']; ?>" class="btn btn-danger btn-sm">Delete</a>
                        </td>
                    </tr>
